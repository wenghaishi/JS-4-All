  ...
  return (
    <div className="h-screen bg-black text-white pt-16 flex flex-col items-center">
      ...
      <div className="grid grid-cols-2 w-full px-10 gap-10 mt-10">
        <div className="border border-neutral-50/30 rounded-xl flex items-center justify-center h-44 text-3xl">React</div>
        <div className="border border-neutral-50/30 rounded-xl flex items-center justify-center h-44 text-3xl">Javascrip</div>
