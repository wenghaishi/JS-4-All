...
function Features() {
  return (
    <section className="flex flex-col py-36 md:px-20 px-10 bg-black text-white items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-evenly w-full mt-10">
        ...
        <Link href="/lessons" className="p-12 border rounded-xl border-neutral-100/30 flex flex-col items-center justify-evenly text-center feature-card3">
